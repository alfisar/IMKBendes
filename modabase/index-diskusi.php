      ...
      <div class="container-fluid">
        <div class="row page-titles">
          <div class="col-md-5 col-sm-12 align-self-center">
            <h1 class="weight-500 m-0">Diskusi</h1>
          </div>
        </div>
        <div class="row">
            <!-- Column -->
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-9">
                          ...
                          <p class="font-16 m-b-30"> Bahas ragam soal materi pembelajaran atribut, mulai diskusi sekarang</p>
                          <button class="btn btn-primary bbtn-primary rounded pr-4 pl-4" id="atribut">Diskusi</button>
                      </div>
                      <div class="col-md-3">
                      <div class="icon-soal" >
                        <p style="font-size:5em"><i class="fas fa-shapes"></i></p>
                      </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-9">
                          ...
                          <p class="font-16 m-b-30"> Bahas ragam soal materi pembelajaran kardinalitas, mulai diskusi sekarang </p>
                          <button class="btn btn-primary bbtn-primary rounded pr-4 pl-4" id="kardinalitas">Diskusi</button>
                      </div>
                      <div class="col-md-3">
                      <div class="icon-soal" >
                        <p style="font-size:5em"><i class="fas fa-list-ol"></i></p>
                      </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-9">
                          <h3 class="weight-500 m-b-25">Entitas</h3>
                          ...
                          <button class="btn btn-primary bbtn-primary rounded pr-4 pl-4" id="entitas">Diskusi</button>
                      </div>
                      <div class="col-md-3">
                      <div class="icon-soal" >
                        <p style="font-size:5em"><i class="fas fa-users"></i></p>
                      </div>
                      </div>
                    </div>
                  </div>
            ...
            <!-- <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-9">
                          <h3 class="weight-500 m-b-25" id="atribut">Spesialisasi</h3>
                          <p class="font-16 m-b-30"> ponderum dissentias theophrastus id sed, et suas homero per. Tota erat docendi in usu. Agam officiis has te. </p>
                          <button class="btn btn-primary bbtn-primary rounded pr-4 pl-4">Diskusi</button>
                      </div>
                      <div class="col-md-3">
                      <div class="icon-soal" >
                        <p style="font-size:5em"><i class="fas fa-project-diagram"></i></p>
                      </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-9">
                          <h3 class="weight-500 m-b-25" id="atribut">Generalisasi</h3>
                          <p class="font-16 m-b-30"> ponderum dissentias theophrastus id sed, et suas homero per. Tota erat docendi in usu. Agam officiis has te. </p>
                          <button class="btn btn-primary bbtn-primary rounded pr-4 pl-4">Diskusi</button>
                      </div>
                      <div class="col-md-3">
                      <div class="icon-soal" >
                        <p style="font-size:5em"><i class="fas fa-code-branch"></i></p>
                      </div>
                      </div>
                    </div>
                  </div>
...
<script>
    ...
    $('#kardinalitas').click(function () {
	  ...
	  $('#entitas').click(function () {
			window.location.href = 'diskusiT.php?materi=entitas';
	  });
   $(function() {
       $('#myTable').DataTable();
